...
from aes2.nn.samplers.pc2_first import PC2FirstSampler
...
from baseline_reg.models import AESRegressionModel
...
if __name__ == '__main__':
    ...
    sampler = PC2FirstSampler(df_train[["essay_id", "is_pc2", "score"]], batch_size=config.train.batch_size)
